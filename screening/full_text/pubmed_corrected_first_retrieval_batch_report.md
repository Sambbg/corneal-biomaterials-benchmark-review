...
This report applies and verifies manual layer-label corrections to the first PubMed retrieval batch after the automated layer-label audit flagged possible inconsistencies.

## Counts

- First-batch records checked: 80
- Records with actual layer-label changes: 12
- Records reviewed but unchanged: 68

## Correction Status Counts

- reviewed_unchanged: 68
- corrected: 12
...
## Actual Layer Corrections Applied
...
- Actual corrections applied only: `screening/full_text/pubmed_first_batch_layer_corrections_applied.csv`
