# First Batch Retrieval Tracker Corrected Layers Report

## Purpose

This report creates an updated first-batch retrieval tracker using the manually corrected biological layer labels.

## Counts

- Tracker records updated: 80
