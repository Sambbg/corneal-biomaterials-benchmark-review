...
const abstractBlock = [
  ...
  bodyPara("**Methods.** Cornea-focused primary literature was drawn from a larger, systematically screened PubMed corpus (four layer-specific search blocks, 1,082 unique records after deduplication) built for a related project; this report concentrates specifically on the subset of 24 primary studies published in 2025–2026 across the endothelium, stroma, and epithelium/limbus, supplemented by four studies selected for in-depth case analysis."),
...
children.push(h2("Table 1. Representative 2025–2026 corneal tissue-engineering studies"));
