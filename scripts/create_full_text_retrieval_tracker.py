...
OUTPUT = Path("screening/full_text/pubmed_full_text_retrieval_tracker.csv")
REPORT = Path("screening/full_text/pubmed_full_text_retrieval_tracker_report.md")
...
status_counts = Counter(r["final_core_status"] for r in out_rows)

with REPORT.open("w", encoding="utf-8") as f:
    f.write("# PubMed Full-Text Retrieval Tracker Report\n\n")

    f.write("## Purpose\n\n")
    f.write("This tracker records full-text retrieval status for the provisional final PubMed core records before extraction.\n\n")

    f.write("## Counts\n\n")
    f.write(f"- Records in retrieval tracker: {len(out_rows)}\n\n")
...
print("Full-text retrieval tracker created.")
